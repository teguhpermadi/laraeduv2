        ...
        <div class="bg-white/10 p-4 rounded-md">
            <table class="text-white w-full max-w-2xl mx-auto">
                ...
                <tr>
                    ...
                    <td>{{ $legerRecapHalfSemester->created_at->format('d F Y') }} Pukul
                        {{ $legerRecapHalfSemester->created_at->format('H:i') }}</td>
                </tr>
            </table>
        </div>
    </div>
        ...
        <div class="bg-white/10 p-4 rounded-md">
            <table class="text-white w-full max-w-2xl mx-auto">
                ...
                <tr>
                    ...
                    <td class="px-3">:</td>
                    {{-- buat format tanggal menjadi 30 November 2024 --}}
                    <td>{{ $legerRecapFullSemester->created_at->format('d F Y') }} Pukul
                        {{ $legerRecapFullSemester->created_at->format('H:i') }}</td>
                </tr>
            </table>
        </div>
    </div>
